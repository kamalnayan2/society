...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $query = "SELECT * FROM member WHERE memberid = $1 AND mobileno = $2";
    $result = pg_prepare($conn, "check_member", $query);
    $result = pg_execute($conn, "check_member", array($member_id, $mobile));
    ...
    if ($user) {
        ...
        if ($new_password === $confirm_password) {
            ...
            $query = "UPDATE member SET password = $1 WHERE memberid = $2";
        ...
        echo "Member ID or mobile number not found.";
    }
}
?>
    ...
    <section class="container">
        <div class="login-container">
            ...
            <form action="" method="post">
                <input type="text" placeholder="MEMBER ID" name="member_id" required />
